...
| sgt | 1 | -64 to 63 | Sensorless homing threshold for TMC5160, TMC2240, TMC2130, TMC2660. Set value appropriately if using sensorless homing (A higher value makes stallGuard2 less sensitive and requires more torque to indicate a stall.) |
